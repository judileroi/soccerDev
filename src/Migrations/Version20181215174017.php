 ...
 */
final class Version20181215174017 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE activity ADD start_date DATETIME NOT NULL, ADD end_date DATETIME NOT NULL, DROP begin, DROP end');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE activity ADD begin DATETIME NOT NULL, ADD end DATETIME NOT NULL, DROP start_date, DROP end_date');
    }
}
